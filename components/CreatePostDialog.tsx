  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          <DialogTitle>Sell Account</DialogTitle>
          <DialogDescription>
            Post your account for sale
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          <Button
            onClick={successMessage ? () => { setIsOpen(false); setSuccessMessage(""); } : handleCreatePost}
            disabled={isLoading}
          >
            {isLoading ? <Loader2 className="animate-spin" /> : successMessage ? "Close" : "Post"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
